...
d.occs <- "C:/SCHOOL/Thesis/Distribution Records/Desmalopex leucopterus"
# create path to user occurrences csv file
userOccs.path <- file.path(d.occs, "D. leucopterus 09_06_22 user_processed_occs.csv")
# read in csv
...
csvPath <- 'C:/SCHOOL/Thesis/Environmental Data/Extent Polygons/PH Luzon Only Polygon Vertices.csv'
...
dismo::response(evalMods[["rm.1.0_fc.LQH"]], var = c('bio2_watermasked','bio4_watermasked', 'bio8_watermasked', 'bio13_watermasked', 'bio14_watermasked', 'bio18_watermasked', 'bio19_watermasked', 'GLADTreeCover_watermasked'))
```
