...
d.occs <- "C:/SCHOOL/Thesis/Distribution Records/Pteropus pumilus"
# create path to user occurrences csv file
userOccs.path <- file.path(d.occs, "P. pumilus 09_06_22 for wallace modelling (processed).csv")
# read in csv
...
dismo::response(evalMods[["rm.0.75_fc.LQH"]], var = c('bio2_watermasked','bio4_watermasked', 'bio8_watermasked', 'bio13_watermasked', 'bio14_watermasked', 'bio18_watermasked', 'bio19_watermasked', 'GLADTreeCover_watermasked'))
```
...
mod <- evalMods[["rm.0.75_fc.LQH"]]
mod #opens html file with percent contributions!!!11!
```

```{r}
# generate raw prediction
pred <- evalPreds[["rm.0.75_fc.LQH"]]
```
