...
userOccs.path <- file.path(d.occs, "P. vampyrus 09_06_22 for wallace modelling (processed).csv")
# read in csv
...
csvPath <- 'C:/SCHOOL/Thesis/Environmental Data/Extent Polygons/PH Country Polygon.csv'
